...
if (!empty($category_title)) {
        ...
        if ($category_logo['size'] > 0 && $category_logo['size'] <= 10 * 1024 * 1024) {
            ...
            if (in_array($file_extension, $allowed_extensions)) {
                ...
                if (move_uploaded_file($category_logo['tmp_name'], $upload_file)) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO categories (category_logo, category_title) VALUES (:category_logo, :category_title)");
    ...
    echo json_encode(["message" => "Пожалуйста, введите название категории."]);
}
